...
/**
 * Created by mohamed on 09/05/16.
 */
 ...
 */
public class TourVrVideoActivity extends Activity {
    private static final String TAG = TourVrVideoActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour_vrvideo_layout);

        seekBar = (SeekBar) findViewById(R.id.seek_bar_tour);
        seekBar.setOnSeekBarChangeListener(new SeekBarListener());
        statusText = (TextView) findViewById(R.id.status_text_tour);
        desc= (TextView) findViewById(R.id.desc_tour);
        title= (TextView) findViewById(R.id.title_tour);
      //  desc.setText(getString(R.string.test));
...
//        sourceText.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        videoWidgetView = (VrVideoView) findViewById(R.id.video_view_tour);
        ...
        int id = i.getIntExtra("IDtour",6);
        try {
            // Uri myUri = Uri.parse("lj1E-Gc5RyQ");
            // if (uri == null || uri.length < 1 || uri[0] == null) {
            if(id==0) {
                videoWidgetView.loadVideoFromAsset("nile.mp4");
                desc.setText(getString(R.string.tourdec1));
                title.setText(getString(R.string.tour1));

            }
            else if(id==1) {
                videoWidgetView.loadVideoFromAsset("abusimbel.mp4");
                desc.setText(getString(R.string.tourdec2));
                title.setText(getString(R.string.tour2));
            }
            else if(id==2) {
                videoWidgetView.loadVideoFromAsset("karnaktemple.mp4");

                desc.setText(getString(R.string.tourdec3));
                title.setText(getString(R.string.tour3));
...
//                videoWidgetView.loadVideo(uri[0]);
            ...
            videoWidgetView.post(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(TourVrVideoActivity.this, "Error opening file. ", Toast.LENGTH_LONG).show();
                }
            });
...
private class ActivityEventListener extends VrVideoEventListener {
    ...
    public void onLoadError(String errorMessage) {
        ...
        loadVideoSuccessful = false;
        Toast.makeText(
                TourVrVideoActivity.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                .show();
